import { IPCFormPurpose, IPCForm } from './formtypes.js';
...
export interface ApiFormulasResponse {
    formulas: IPCFormula[];
}
...
export interface ApiGraphsResponse {
    graphs: IPCGraphConfig[];
}
export interface ApiPicklistsResponse {
    picklists: IPCPickListConfig[];
}
export interface ApiPicklistDataResponse {
    data: IPCPickListData;
}
export interface ApiGraphDataResponse {
    data: IPCGraphData;
}
export interface ApiPlayoffResponse {
    bracket: IPCPlayoffStatus;
}
export interface ApiUpsertFormulasRequest {
    formulas: IPCFormula[];
}
export interface ApiUpsertDatasetsRequest {
    datasets: IPCDataSet[];
}
export interface ApiUpsertGraphsRequest {
    graphs: IPCGraphConfig[];
}
export interface ApiUpsertPicklistsRequest {
    picklists: IPCPickListConfig[];
}
export interface ApiSetPlayoffRequest {
    bracket: IPCPlayoffStatus;
}
